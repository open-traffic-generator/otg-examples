...
* [Remote Triggered Blackhole Lab](/clab/rtbh) (RTBH) - widely used DDoS mitigation technique, uses BGP anouncements to request an ISP to drop all traffic to an IP address under a DDoS attack.
